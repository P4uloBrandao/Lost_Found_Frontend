  ...
  if (categories.length === 0){
   ...
   function extractSubcategories(categories) {
    ...
    const handleDeleteSubCategory = async (event) => {
        ...
        try {
            const response = await axios.delete(`https://bidfinderbackend.ddns.net/api/category/subCat/${getCategoryNameFromId(mainCategoryToDelete)}/${getSubCategoryNameFromId(subCategoryToDelete)}`,);
    ...
    const handleCreateSubCategory = async (event) => {
      ...
      try {
          const response = await axios.post(`https://bidfinderbackend.ddns.net/api/category/subCat/${getCategoryNameFromId(mainCategory)}`,{"name": subCategoryToCreate});
