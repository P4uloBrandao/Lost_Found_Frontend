...
const Terms = () => {
    return (
        <section className='w-full flex flex-col justify-center items-center py-12 bg-bgAbout gap-8'>
            <article className='w-3/4 flex flex-col items-start gap-4'><h1 className='text-4xl font-extrabold text-titleAbout'>Terms and Conditions</h1>
                ...
                <div className='flex flex-col gap-2'>
                    <h2 className='text-3xl text-bold text-titleAbout'>Article 1 - General Provisions</h2>
                ...
                <div className='flex flex-col gap-2'>
                    <h2 className='text-3xl text-bold text-titleAbout'>Article 2 - Orders</h2>
                ...
                <div className='flex flex-col gap-2'>
                    <h2 className='text-3xl text-bold text-titleAbout'>Article 3 - Payment</h2>
                ...
                <div className='flex flex-col gap-2'>
                    <h2 className='text-3xl text-bold text-titleAbout'>Article 4 - Delivery</h2>
                ...
                <div className='flex flex-col gap-2'>
                    <h2 className='text-3xl text-bold text-titleAbout'>Article 5 - Prices and Taxes</h2>
                ...
                <div className='flex flex-col gap-2'>
                    <h2 className='text-3xl text-bold text-titleAbout'>Article 6 - Cancellation and Returns</h2>
                ...
                <div className='flex flex-col gap-2'>
                    <h2 className='text-3xl text-bold text-titleAbout'>Article 7 - Customer Data</h2>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <p>For support and inquiries, contact us at support@ourcompany.com.</p>
                </div>
            </article>
        </section>
    )
